  ...
  return (
    ...
    >
      <div className="loader-icon-motion">
        <svg aria-hidden="true" className="h-[120px] w-[120px] animate-spin" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
          <path fill="currentColor" d={SOCCER_ICON_PATH} />
        </svg>
      </div>
    </div>
  )
